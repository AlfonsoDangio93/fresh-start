      ...
      <div className="max-w-site mx-auto px-6 pt-14 pb-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-6 gap-4">
          ...
          <div className="flex items-center gap-3 text-[13px]">
            <Link href="#" className="text-secondary/50 hover:text-dark transition-colors duration-200 cursor-pointer">
              Privacy Policy
            </Link>
        ...
        <div className="text-center mt-6">
          <span className="text-[12px] text-secondary/30">Powered by Mamazen</span>
        </div>
      </div>
    </footer>
  );
